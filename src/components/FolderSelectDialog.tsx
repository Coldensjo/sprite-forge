...
import { Folder, ChevronRight, ChevronLeft, X, Home, File, CheckCircle2, Star } from "lucide-react";
...
export const FolderSelectDialog = ({
  ...
  const [selectedSystemDir, setSelectedSystemDir] = useState<string | null>(null);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[600px] p-0 gap-0 flex flex-col [&>button]:hidden">
        ...
        <DialogDescription className="sr-only">
          Browse and select a folder containing Tibia files
        </DialogDescription>
