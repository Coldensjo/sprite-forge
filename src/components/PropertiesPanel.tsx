    ...
    <div className="flex-1 bg-card rounded-lg shadow-island-lg flex flex-col overflow-hidden">
      ...
      <Tabs defaultValue="appearance" className="flex-1 flex flex-col">
        <TabsList className="mx-4 mt-2 w-auto">
          <TabsTrigger value="appearance">Properties</TabsTrigger>
        </TabsList>
                      ...
                      <div className="grid grid-cols-4 gap-1.5 mb-2">
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            max="128"
                            defaultValue="1"
                            className="h-8 text-xs font-mono text-right bg-background/50 border-border/50 hover:border-primary/50 transition-colors"
                          />
                        </div>
                        <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-3 gap-1.5">
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            max="128"
                            defaultValue="4"
                            className="h-8 text-xs font-mono text-center bg-background/50 border-border/50 hover:border-primary/50 transition-colors"
                          />
                        </div>
                        <div className="space-y-1">
